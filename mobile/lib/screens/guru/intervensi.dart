...
class _GuruIntervensiState extends State<GuruIntervensi> {
  ...
  @override void initState(){ super.initState(); ApiService.get("/api/mobile/guru/intervensi").then((v){ if(mounted) setState(()=>{data=v is List?v:[]; loading=false;}); }).catchError((_){ if(mounted) setState(()=> loading=false);}); }

...
class _GuruAntiCheatState extends State<GuruAntiCheat> {
  ...
  @override void initState(){ super.initState(); ApiService.get("/api/mobile/guru/anti-cheat").then((v){ if(mounted) setState(()=>{data=v is List?v:[]; loading=false;}); }).catchError((_){ if(mounted) setState(()=> loading=false);}); }

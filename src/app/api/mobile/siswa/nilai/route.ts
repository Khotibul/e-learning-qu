...
export async function GET(req:Request){
  try{
    ...
    // Samakan dengan website getNilaiList: flat {id, mapel, semester, jenis, nilai, keterangan, tanggal}
    const mapped = nilais.map((n) => ({ id: n.id, mapel: n.mataPelajaran.nama, semester: n.semester.nama, jenis: n.jenis, nilai: n.nilai, keterangan: n.keterangan, tanggal: n.createdAt.toISOString() }));

...
export async function GET(req:Request){
  try{
    ...
    const jadwal=await prisma.jadwalPelajaran.findMany({where:{kelasId:siswa.kelasId, deletedAt:null}, include:{mataPelajaran:{select:{nama:true}}}, orderBy:[{hari:"asc"},{jamMulai:"asc"}]});

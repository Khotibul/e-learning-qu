...
export const NAV_ITEMS = {
  ...
  SISWA: [
    ...
    { label: "AI Tutor", href: "/siswa/ai-tutor", icon: "Bot" },
    { label: "AI Analitik", href: "/siswa/ai-analitik", icon: "BarChart3" },
    ...
    { label: "Materi", href: "/siswa/materi", icon: "BookOpen" },
    { label: "Struktur Kelas", href: "/siswa/struktur-kelas", icon: "Users" },
    { label: "Jadwal Piket", href: "/siswa/jadwal-piket", icon: "ClipboardList" },
